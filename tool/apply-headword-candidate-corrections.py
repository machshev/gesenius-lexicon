...
def apply(root, journal, corrections_path):
    ...
    for key, correction in {**not_headwords, **crop_corrections}.items():
    ...
    print(f'Applied {len(not_headwords)} false-candidate decisions and {len(crop_corrections)} crop corrections; recorded {len(appended)} canonical audit records.')
